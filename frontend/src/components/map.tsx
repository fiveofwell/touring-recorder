...
const SetMarkers = ({ points }: { points: Point[] }) => {
	if (points.length === 0) return null;
  	...
  	const startMarkerPosition: [number, number] = [startPoint.latitude, startPoint.longitude];
	const endMarkerPosition: [number, number] = [endPoint.latitude, endPoint.longitude];
