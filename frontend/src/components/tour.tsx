...
import type { TourLinkProps, TourDetailProps } from './types';
...
export const TourDetail = ({ tour_id, tour_name, device_id, started_at, last_seen_at, onDelete}: TourDetailProps) => {
